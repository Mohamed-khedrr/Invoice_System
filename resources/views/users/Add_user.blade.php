                ...
                <div class="card-body">
                    <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">role_name</label>
                                <select name="roles_name" class="form-control SlectBox" onclick="console.log($(this).val())"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission" name="status"
                                    required>
                            </div>
