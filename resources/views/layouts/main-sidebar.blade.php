        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                            href="{{ url('/' . ($page = 'paid_invoices')) }}">الفواتيرالمدفوعة</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'unpaid_invoices')) }}">الفواتير الغير
                            مدفوعة</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'part_paid')) }}">الفواتير المدفوعة
                            جزئيا</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'show_archive')) }}">ارشيف الفواتير
                        </a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-compose')) }}">قائمة
                            المستخدمين</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-read')) }}">صلاحيات
                            المستخدمين</a>
                    </li>
                </ul>
            </li>
