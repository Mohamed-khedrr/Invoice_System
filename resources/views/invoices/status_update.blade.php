...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('update_status', $invoice) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('GET')
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="value_status" class="form-control">
                                    <option value="{{ $invoice->value_status }}" selected>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoice->created_at }}" required readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="Section" class="form-control SlectBox" readonly
                                    value="{{ $invoice->Section->section_name }}">
                                <!--placeholder-->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control form-control-lg"
                                    value="{{ $invoice->discount }}" id="Discount" name="Discount"
                            ...
                            <div class="col">
                                ...
                                <input name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()"
