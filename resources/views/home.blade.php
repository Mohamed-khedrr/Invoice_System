                            ...
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                        ${{ $total = number_format(\App\Invoice::sum('total'), 2) }}
                                    </h4>
                                    <p class="mb-0 tx-12 text-white op-7">{{ \App\Invoice::count() }}</p>
                                </div>
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                        ${{ $unPaid = number_format(\App\Invoice::where('value_status', 3)->sum('total'), 2) }}
                                    </h4>
                                ...
                                <span class="float-right my-auto mr-auto">
                                    ...
                                    <span
                                        class="text-white op-7">{{ round((\App\Invoice::where('value_status', 3)->sum('total') / \App\Invoice::sum('total')) * 100) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                        ${{ number_format(\App\Invoice::where('value_status', 1)->sum('total')) }}
                                    </h4>
                                    <p class="mb-0 tx-12 text-white op-7">
                                        {{ \App\Invoice::where('value_status', 1)->count() }}</p>
                                </div>
                                <span class="float-right my-auto mr-auto">
                                    <i class="fas fa-arrow-circle-up text-white"></i>
                                    <span class="text-white op-7">
                                        {{ round((\App\Invoice::where('value_status', 1)->sum('total') / \App\Invoice::sum('total')) * 100) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    ...
                                    <p class="mb-0 tx-12 text-white op-7">
                                        {{ \App\Invoice::where('value_status', 2)->count() }}</p>
                                </div>
                                <span class="float-right my-auto mr-auto">
                                    <i class="fas fa-arrow-circle-up text-white"></i>
                                    <span class="text-white op-7">
                                        {{ round((\App\Invoice::where('value_status', 2)->sum('total') / \App\Invoice::sum('total')) * 100) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
